...
const AddCredentialModal = ({ isOpen, onClose, onSave, assets }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4"> 
      ...
      <div className="relative bg-white rounded-xl w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden max-h-[90vh] flex flex-col">
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          ...
          <button 
            ...
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 shadow-sm font-medium transition-all hover:shadow-md active:scale-95"
          >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50 p-3 rounded-lg border border-slate-200">
        ...
        <div className="flex bg-slate-200/50 p-1 rounded-lg w-full md:w-auto overflow-x-auto whitespace-nowrap">
          {[
            { id: 'ALL', label: 'Todos' },
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
        <div className="overflow-x-auto w-full">
            ...
            <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Tipo</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Identificação</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Usuário</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Senha</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-right whitespace-nowrap">Ações</th>
                </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
                {loading ? (
                    ...
                    <tr key={cred.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-4 flex justify-end gap-2 whitespace-nowrap">
                            <button 
