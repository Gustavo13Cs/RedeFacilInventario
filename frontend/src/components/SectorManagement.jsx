          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-6">
            ...
            <div className="flex gap-3 max-w-md">
              <input 
                ...
                className="flex-1 h-10 rounded-md border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none shadow-sm"
              />
              <button 
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-100 hover:bg-slate-100">
                  <TableHead className="font-bold text-slate-700">Máquina (Hostname)</TableHead>
                  <TableHead className="font-bold text-slate-700">Endereço IP</TableHead>
                  <TableHead className="font-bold text-slate-700">Setor Atual</TableHead>
              ...
              <TableBody>
                {machines.map((machine) => (
                  <TableRow key={machine.uuid} className="hover:bg-slate-50">
                    <TableCell className="font-medium text-slate-800">{machine.hostname}</TableCell>
                    ...
                    <TableCell>
                      <div className="relative">
                        <select 
                          className="h-9 w-full max-w-[220px] rounded-md border border-slate-300 text-sm px-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white cursor-pointer"
